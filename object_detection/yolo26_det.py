...
def main():
    ...
    parser.add_argument('--model-path', type=str, default='/home/sunrise/Desktop/ECR/models/yolov12n_detect_bayese_640x640_nv12_modified.bin', 
                        help="""Path to BPU Quantized *.bin Model.
                                ...
                                RDK S100: Nash-e.
                                RDK S100P: Nash-m.""") 
    parser.add_argument('--test-img', type=str, default='/home/sunrise/Desktop/mono2d/config/person_body.jpg', help='Path to Load Test Image.')
